...
docker run -d \
    -v $(pwd)/www/client:/var/www/site/client -v $(pwd)/www/log:/var/www/site/log -v $(pwd)/www/feedback:/var/www/site/feedback  -v $(pwd)/www/.well_known:/var/www/site/.well_known \
